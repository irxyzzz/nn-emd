...
class NeuralNetMLP(object):
    ...
    def __init__(self, n_output, n_features, n_hidden=30,
                 ...
                 minibatches=1, random_state=None, sc_flag=False):
        ...
        self.flag = sc_flag
        if self.flag:
            self.sc = SecureComputation(n_features + 1)
    ...
    def _get_gradient(self, a1, a2, a3, z2, y_enc, w1, w2):
        ...
        sigma3 = a3 - y_enc
        # print(y_enc.shape)
        # change sigma3 for test
        # sigma3 = - (np.divide(y_enc, a3) - np.divide(1 - y_enc, 1 - a3))
