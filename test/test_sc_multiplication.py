import sys
sys.path.append("..")
from nn.utils_sc_multiplication import secure_multiplication_multiprocessing_cost
import csv
import numpy as np
...
def test_secure_computation_multiplication_multiprocess_statistic():
    ...
    print("testing the scm in multiprocessing program")
        ...
        for j in test_max_vector_value_list:
            for m in test_max_res_shape0_list:
                for n in test_max_res_shape1_list:
                    ...
                    dot_result, enc_cost, key_cost, dec_cost = secure_multiplication_multiprocessing_cost(Y, A, 1, 1)
                    # print(dot_result)
